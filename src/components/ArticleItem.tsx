...
function ArticleItem({ articleData }: { articleData: Article }) {
  return (
    <>
      <div className="article">
        ...
        <div className="article__body">
          ...
          <p className="article__price">
            {articleData.price} SEK
            <span className="article__discount">
              {(
                ((articleData.originalPrice - articleData.price) * 100) /
                articleData.originalPrice
              ).toFixed()}
              %
            </span>
            <span className="article__original-price">
              {articleData.originalPrice} SEK
            </span>
          </p>
