...
function AddToCart({ articleData }) {
    ...
    const item = { "id": articleData._id, "title": articleData.title, "price": articleData.price, "thumbnail": articleData.images[0].thumbnail };
    return (
        <>
